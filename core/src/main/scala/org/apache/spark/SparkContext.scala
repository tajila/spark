...
class SparkContext(config: SparkConf) extends Logging {
  ...
  val runTimeCpu : AtomicLong = new AtomicLong(0)

  val runTime : AtomicLong = new AtomicLong(0)

  val runningMap = new ConcurrentHashMap[String, Long]()
...
object SparkContext extends Logging {
  ...
  val runningRecords = new AtomicLong(0)
